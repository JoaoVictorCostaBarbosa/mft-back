use crate::adapters::http::{
    ...
    dtos::{
        ...
        workout_plan::{
            ...
            RoutineItemTypeDTO, RoutineModeDTO, WorkoutPlanRequestDTO, WorkoutPlanResponseDTO,
            WorkoutPlanRoutineItemResponseDTO, WorkoutPlanRoutineItemTemplateResponseDTO,
            WorkoutPlanSummaryResponseDTO, WorkoutPlanUpdateNameRequestDTO,
        },
        workout_template::{
