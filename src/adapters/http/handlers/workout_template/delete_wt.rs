...
#[utoipa::path{
    ...
    params(
        ("workout_id" = Uuid, description = "Workout template ID to be deleted", example = "b728b759-4d32-4148-936e-d9036c071d72"),
    ),
    responses(
...
pub async fn delete_workout_template_handler(
